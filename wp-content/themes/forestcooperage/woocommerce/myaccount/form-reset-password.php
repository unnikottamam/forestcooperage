...
<div class="row justify-content-center">
   <div class="col-md-8 col-lg-6">
      <form method="post" class="woocommerce-ResetPassword lost_reset_password">
         ...
         <div class="woocommerce-form-row woocommerce-form-row--first form-row flex-column form-row-first">
         ...
         <input type="hidden" name="reset_key" value="<?php echo esc_attr(
           $args['key']
         ); ?>" />
         <input type="hidden" name="reset_login" value="<?php echo esc_attr(
           $args['login']
         ); ?>" />
         ...
         <button type="submit" class="woocommerce-Button btton btton-outline-primary btn-sm" value="<?php esc_attr_e(
           'Save',
           'woocommerce'
         ); ?>">
