...
<div class="u-columns col2-set justify-content-between row" id="customer_login">
    ...
    <div class="u-column1 col-lg-5 col-md-6 mt-1 pb-3 col-12">
        ...
        <form class="form-row flex-column woocommerce-form woocommerce-form-login login" method="post">
            ...
            <div class="form-check my-3 custom-checkbox">
                <input class="custom-control-input form-check-input woocommerce-form__input woocommerce-form__input-checkbox"
                    name="rememberme" type="checkbox" id="rememberme" value="forever" />
                <label
                    class="custom-control-label form-check-label woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme"
                    for="rememberme">
            ...
            <div class="row align-items-center">
                <div class="col-sm-4 col-12 mb-1">
                    <button type="submit"
                        class="woocommerce-button btton btton-sm btton-outline--primary woocommerce-form-login__submit"
    ...
    <div class="u-column2 col-lg-5 col-md-6 mt-1 col-12">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action(
          'woocommerce_register_form_tag'
            ...
            <button type="submit"
                class="woocommerce-Button woocommerce-button btton btton-outline-primary btn-sm woocommerce-form-register__submit"
