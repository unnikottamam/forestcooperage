...
$show_purchase_note = $order->has_status(
  apply_filters('woocommerce_purchase_note_order_statuses', [
    'completed',
    'processing',
  ])
);
$show_customer_details =
  is_user_logged_in() && $order->get_user_id() === get_current_user_id();
...
<section class="woocommerce-order-details">
    ...
    <table class="table"class="woocommerce-table woocommerce-table--order-details shop_table table order_details">
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td data-title="<?php echo esc_html($total['label']); ?>">
                    <?php echo 'payment_method' === $key
                      ? esc_html($total['value'])
            ...
            <tr>
                ...
                <td data-title="<?php esc_html_e('Note:', 'woocommerce'); ?>">
