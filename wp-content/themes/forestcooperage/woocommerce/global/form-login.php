      ...
      <form class="woocommerce-form woocommerce-form-login login form-row flex-column" method="post" <?php echo $hidden
        ...
        : ''; ?>>
         ...
         <div class="form-check custom-checkbox my-3">
            <input class="woocommerce-form__input woocommerce-form__input-checkbox custom-control-input form-check-input"
               name="rememberme" type="checkbox" id="rememberme" value="forever" />
            <label for="rememberme"
               class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme custom-control-label form-check-label">
         ...
         <div class="row align-item-center pb-2">
            <div class="col-md-4">
               ...
               <button type="submit"
                  class="woocommerce-button button woocommerce-form-login__submit btton btton-sm btton-outline--primary mb-1"
