...
?>
<div id="payment" class="woocommerce-checkout-payment payment_gateways">
    ...
    <div class="form-row place-order">
        <noscript>
            ...
            <br /><button type="submit" class="button alt btton btton-success"
                name="woocommerce_checkout_update_totals" value="<?php esc_attr_e(
                  'Update totals',
                  'woocommerce'
                ); ?>"><?php esc_html_e(
  'Update totals',
  'woocommerce'
        ...
        <?php echo apply_filters(
          ...
          '<button type="submit" class="button alt btton btton-success" name="woocommerce_checkout_place_order" id="place_order" value="' .
