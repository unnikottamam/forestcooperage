    ...
    <h3 id="ship-to-different-address" class="mt-lg-3">
        <div class="form-check custom-checkbox">
            <input id="ship-to-different-address-checkbox"
                class="form-check-input woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" <?php checked(
                  apply_filters(
            ...
            <label
                class="form-check-label ship_diff woocommerce-form__label woocommerce-form__label-for-checkbox checkbox"
...
<div class="woocommerce-additional-fields">
    ...
    <div class="woocommerce-additional-fields__field-wrapper">
        <?php foreach (
          $checkout->get_checkout_fields('order')
          as $key => $field
        ): ?>
