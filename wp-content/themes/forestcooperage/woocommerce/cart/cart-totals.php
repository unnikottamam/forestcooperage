...
<div class="cart_totals <?php echo WC()->customer->has_calculated_shipping()
  ...
  : ''; ?>">
    ...
    <table class="table"cellspacing="0" class="shop_table table cart__totals shop_table_responsive">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr class="cart-discount coupon-<?php echo esc_attr(
              sanitize_title($code)
            ); ?>">
                <th><?php wc_cart_totals_coupon_label($coupon); ?></th>
                <td data-title="<?php echo esc_attr(
            ...
            <tr class="tax-rate tax-rate-<?php echo esc_attr(
              sanitize_title($code)
            ); ?>">
