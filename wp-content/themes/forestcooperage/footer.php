...
<div class="footer__testi bg-success text-white text-center">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 col-11">
                <h3 data-aos="fade-up"><?php echo $testi[0]['title']; ?></h3>
                <p data-aos="fade-up"><?php echo $testi[0][
                  'description'
                ]; ?></p>
                <div data-aos="fade-up" class="footer__testiimg">
    ...
    <div data-aos="fade-right" class="footer__testiside d-none d-lg-block"></div>
</div>
<?php
}
?>
<div class="instasec">
    <div data-aos="fade-up" class="instasec__img">
        <a href="#">
    ...
    <div class="container text-center text-md-start">
        <div class="row justify-content-center">
            <div class="col-12 footer__widget text-center">
                <a data-aos="fade-up" href="<?php echo home_url(); ?>" class="footer__logo">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/footer-logo.png" alt="logo">
                </a>
            </div>
            <div data-aos="fade-up" class="col-lg-8 col-md-10 text-center footer__widget">
                <?php the_field('footer_widget_1', 'options'); ?>
            </div>
            <div data-aos="fade-up" class="col-12 footer__widget">
            ...
            <div data-aos="fade-up" class="col-md-4 footer__widget">
