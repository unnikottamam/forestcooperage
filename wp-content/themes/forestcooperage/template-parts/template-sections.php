...
<section class="coverbg text-white">
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center py-xl-6 py-lg-5 py-md-4 py-3 min-vh-100">
...
<section class="sideimage py-xl-6 py-lg-5 py-md-4 py-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <ul class="ctalist">
                    <li><a class="btn btn-success" href="#">Our Promise</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<section class="coverbg text-white py-xl-6 py-lg-5 py-md-4 py-3">
    <div class="coverbg__img">
    ...
    <div class="container">
        <div class="row justify-content-lg-end">
            <div class="col-lg-7 text-center text-lg-start">
                ...
                <ul class="ctalist">
                    <li><a class="btn btn-primary" href="#">Our Roots</a></li>
                    <li><a class="btn btn-light" href="#">Our Values</a></li>
                </ul>
            </div>
        </div>
    </div>
