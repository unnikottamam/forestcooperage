      ...
      try {
        ...
        if (!file_exists($img_path) or !getimagesize($img_path)) {
          throw new Aq_Exception(
            'Image file does not exist (or is not an image): ' . $img_path
          );
        }
        // Get image info.
        ...
        if (
          !$dims ||
          (null === $height && $orig_w == $width xor
            null === $width && $orig_h == $height xor
          ...
          if (
            ...
            throw new Aq_Exception(
              'Unable to resize image because image_resize_dimensions() failed'
            );
          }
          ...
          // Else, we resize the image and return the new resized image url.
            ...
            if (!is_wp_error($resized_file)) {
              ...
              throw new Aq_Exception(
                'Unable to save resized image file: ' .
                  $editor->get_error_message()
              );
            }
          }
